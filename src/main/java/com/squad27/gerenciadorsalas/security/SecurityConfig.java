    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorizate -> authorizate
                        ...
                        .requestMatchers(HttpMethod.PUT,  "/api/v1/salas/*/layout").hasRole("ADMIN")
                        // Layout — resultado do agente
                        .requestMatchers(HttpMethod.POST, "/api/v1/salas/*/layout/resultado").hasRole("ADMIN")
